...
electron_1.contextBridge.exposeInMainWorld('petDesktop', {
    ...
    listImportedPetSkins: () => electron_1.ipcRenderer.invoke('pet-skins:list-imported'),
    importPetSkinFolder: () => electron_1.ipcRenderer.invoke('pet-skins:import-folder'),
    ...
    listActiveReminders: () => electron_1.ipcRenderer.invoke('reminders:list-active'),
    updateReminder: (input) => electron_1.ipcRenderer.invoke('reminders:update', input),
